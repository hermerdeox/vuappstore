...
<svelte:head>
	...
	<meta
		name="description"
		content="Manage your VU Suite app downloads. Re-download apps anytime with zero tracking."
	/>
</svelte:head>
...
<div class="account-page container py-16 max-w-6xl relative z-10">
	...
	<section class="hero mb-12">
		...
		<h1 class="text-4xl md:text-5xl font-black mb-4 text-gradient">Your Downloads</h1>
				...
				<div class="flex items-start gap-3">
					...
					<div>
						...
						<p class="text-sm text-text-secondary leading-relaxed">
							We don't track what you download, when you download, or how many times. Your download
							history is stored locally on your device only. We simply provide the files you're
							entitled to access.
						</p>
					</div>
				</div>
							...
							<div class="flex items-center justify-between gap-6">
								<div class="flex items-center gap-4 flex-1">
									...
									<div
										...
										style="background: {download.color}20;"
									>
										<svelte:component
											this={download.iconComponent}
											class="w-8 h-8"
											style="color: {download.color};"
										/>
									</div>
								...
								<div class="flex items-center gap-3">
									<a href="/apps/{download.appId}" class="btn btn-secondary"> View Details </a>
									<button
				...
				<div class="space-y-4">
					<div class="instruction-item">
						<h4 class="font-semibold text-primary mb-2 flex items-center gap-2">
							<Inbox class="w-4 h-4" /> Re-download Anytime
						</h4>
						<p class="text-sm text-text-secondary">
							As long as your subscription is active, you can re-download any VU Suite app unlimited
							times. No questions asked, no tracking, no limits.
						</p>
					</div>
					<div class="instruction-item">
						<h4 class="font-semibold text-primary mb-2 flex items-center gap-2">
							<LockKeyhole class="w-4 h-4" /> Verified Downloads Only
						</h4>
						<p class="text-sm text-text-secondary">
							Every download is cryptographically signed and verified. You'll always get the
							authentic, unmodified application directly from VU.
						</p>
					</div>
					<div class="instruction-item">
						<h4 class="font-semibold text-primary mb-2 flex items-center gap-2">
							<Rocket class="w-4 h-4" /> Automatic Updates
						</h4>
						<p class="text-sm text-text-secondary">
							Apps automatically check for updates in the background. You control when to install
							them. No forced updates, no telemetry.
						</p>
					</div>
					<div class="instruction-item">
						<h4 class="font-semibold text-primary mb-2 flex items-center gap-2">
							<FileDown class="w-4 h-4" /> Offline Installers
						</h4>
						<p class="text-sm text-text-secondary">
							Download standalone offline installers for complete independence. Install on
							air-gapped systems, backup to encrypted drives, or share with other devices on your
							subscription.
						</p>
					</div>
				</div>
