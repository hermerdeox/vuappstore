...
const DYNAMIC_ASSETS = ['/apps/', '/legal/', '/support/', '/developers/', '/resources/', '/about/'];
...
self.addEventListener('fetch', (event) => {
	...
	if (
		NEVER_CACHE.some((pattern) => url.pathname.includes(pattern) || url.hostname.includes(pattern))
	) {
...
self.addEventListener('notificationclick', (event) => {
	...
	if (event.action === 'explore') {
		event.waitUntil(clients.openWindow('/apps'));
