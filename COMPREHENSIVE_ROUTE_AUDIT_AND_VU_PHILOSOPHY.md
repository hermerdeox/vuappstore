...
- *All handled by Stripe (PCI DSS Level 1)*
...
```svelte
✅ Download history (locally stored)
✅ 6 apps with full metadata
✅ Re-download buttons
✅ Version tracking
...
✅ Cancel warning with support links
```
...
✅ Account Information
   - @username (editable)
   - @vumail.app (verified, locked)
   - Password (hashed with Argon2id)

✅ Security Settings
   - Two-Factor Authentication (VuAuth app)
   - Active sessions management
   - Security audit log
   - No SMS 2FA (privacy leak)

✅ Privacy Preferences (All OFF by default)
   - Marketing Communications: OFF
   - Product Updates: OFF
   - Security Alerts: ON (only essential)
   - Anonymous Analytics: OFF
   - Crash Reports: OFF
   - Beta Access: OFF

✅ Language & Region
   - Interface language (EN/ES/FR)
   - Timezone (auto-detect without tracking)

✅ Data & Privacy
   - Data export (GDPR compliant)
   - What We Actually Store (4 items)
...
<input 
  ...
  disabled
/>
<p class="text-xs">✓ Only @vumail.app addresses allowed for maximum privacy. No external email tracking.</p>
```
